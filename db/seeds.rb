...
User.create(email: "user3@example.com", address: "3 First St. 94598",  lat: 37.921307, lng: -122.007946, category: 3, price_paid: 1200)
User.create(email: "user4@example.com", address: "4 First St. 94598",  lat: 37.918793, lng: -122.007946, category: 4, price_paid: 1350)
